...
public class PdfComponent {
   ...
   private static final Logger log = LoggerFactory.getLogger(PdfComponent.class);
    ...
    public static ByteArrayInputStream generarPdf(Reserva reserva) {
        ...
        try {
            ...
            table.addCell(hcell);
                ...
                cell = new PdfPCell(new Phrase(reserva.getId().toString()));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);

                cell = new PdfPCell(new Phrase(reserva.getNombre()));
                cell.setPaddingLeft(5);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);

                cell = new PdfPCell(new Phrase(String.valueOf(reserva.getSucursal())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
