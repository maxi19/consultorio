...
export class SucursalService {
  public resourceUrl = SERVER_API_URL + 'externos/sucursales';

  public resourceInternalUrl = SERVER_API_URL + 'internos/sucursales';

  constructor(private http: HttpClient) {}

  consultarSucursales(): Observable<Sucursal[]> {
    return this.http.post<Sucursal[]>(this.resourceUrl + '/info', null);
  }
